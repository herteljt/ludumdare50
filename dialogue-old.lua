...
dialogue.introduction = {
  ...
  {
    avatarUpper = "catMrowDisappointed",
...
dialogue.scenarioTwoGood = {
  ...
  },
  {
    avatarUpper = "narrator",
    avatarLower = "catNeutral",
    text = "And then they find it, waiting, ready-- hungry. Claws sharp, teeth bared. It is the last thing they see. The bag opens and a new item drops in next to you."
  },
  {
    avatarUpper = "knightHappy",
    avatarLower = "catNeutral",
...
dialogue.scenarioTwoNeutral = {
 ...
 },
  {
    avatarUpper = "narrator",
    avatarLower = "catScared",
    text = "Distracted for a moment by the mass of shadow you knock a precariously placed block of packed snow directly onto the human's head. There is a loud ringing sound and he collapses, unconscious, just as the mass of concentrated darkness breaks upon the half finished igloo."
 },
  {
    avatarUpper = "narrator",
    avatarLower = "catScared",
    text = "The dark spirits manifest in a circle as bent figures in tattered robes, wickedly curved ebony blades raised to the sky as if in offering."
 },
  {
    avatarUpper = "catScared",
    avatarLower = "catScared",
 ...
 },
  {
    avatarUpper = "narrator",
    avatarLower = "catScared",
    text = "'Oh...err...wow, sorry. We were just gonna say hi. Don't get a lot of folk up here for some reason, y'know? This...wow, Uh, so...we're gonna head. Hope your friend is ok, cat.' Sheepishly all of the spirits scatter as dust into the wind."
 },
  {
    avatarUpper = "narrator",
    avatarLower = "catNeutral",
...
dialogue.scenarioTwoBad = {
  ...
  },
  {
    avatarUpper = "catScared",
    avatarLower = "catScared",
    text = "Guhk, Uhrp, Hurrrrrk...."
  },
  {
    avatarUpper = "knightAnnoyed",
    avatarLower = "catNeutral",
    text = "No, no, no, no, no, no, no...don't you dare throw up in my bag, you little monster! Get out of there!"
  },
  {
    avatarUpper = "narrator",
    avatarLower = "fight",
  ...
  },
  {
    avatarUpper = "narrator",
    avatarLower = "catHappy",
    text = "You leap onto the ground just in time for the giant to fall backwards into a crevasse. At last you dislodge the item from your throat along with a wet splat of hair into the snow."
  },
  {
    avatarUpper = "catHappy",
    avatarLower = "catHappy",
